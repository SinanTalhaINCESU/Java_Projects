    ...
    public static void main(String[] args) {
        ...
        switch (secim) {
            case 1:
                ...
                System.out.println();
                System.out.printf("Kenar uzunluğu %d olan karenin çevresi = " + 4 * kenar, kenar);
                break;
            case 2:
                ...
                System.out.println();
                System.out.printf("Yarıçap uzunluğu %d olan dairenin çevresi = " + 2 * Math.PI * yaricap, yaricap);
                break;
            default:
